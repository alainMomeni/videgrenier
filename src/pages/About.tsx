...
interface TeamMember {
  ...
  role: string;
  image: string;
  linkedin: string; // Laisser la propriété, même si elle peut être vide
}
...
const teamMembers: TeamMember[] = [
  {
    name: 'Carine Momeni',
    role: 'Founder & CEO',
    image: '/assets/fina.jpg',
    linkedin: '', // 1. Laisser la valeur vide ici
  },
  {
    name: 'Alain Momeni',
    role: 'Software Engineer',
    image: '/assets/alain.jpg',
    linkedin: 'https://www.linkedin.com/in/alain-momeni-a702442a3/', 
  },
  {
    name: 'Yvan Momo',
    role: 'Software Engineer',
    image: '/assets/yvan.jpg',
