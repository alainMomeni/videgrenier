...
const AdminSettings = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
      <div className="mb-8">
        <h1 className="text-3xl lg:text-4xl font-serif font-bold text-[#2a363b]">Settings</h1>
      ...
      <div className="space-y-10">
        ...
        <div className="bg-[#fcfaf7] border border-[#dcd6c9] rounded-lg shadow-sm">
          <div className="p-6 border-b border-[#dcd6c9]">
            <h2 className="text-xl font-serif font-semibold text-[#2a363b]">Personal Information</h2>
          ...
          <form onSubmit={handleProfileSubmit}>
            ...
            <div className="bg-[#f3efe7] px-6 py-4 text-right rounded-b-lg">
              <button type="submit" className="px-6 py-2 text-sm font-serif text-white bg-[#2a363b] rounded-md hover:bg-opacity-90 transition">Save Changes</button>
            </div>
          </form>
        </div>
        ...
        <div className="bg-[#fcfaf7] border border-[#dcd6c9] rounded-lg shadow-sm">
          <div className="p-6 border-b border-[#dcd6c9]">
            <h2 className="text-xl font-serif font-semibold text-[#2a363b]">Change Password</h2>
          ...
          <form onSubmit={handlePasswordSubmit}>
            ...
            <div className="bg-[#f3efe7] px-6 py-4 text-right rounded-b-lg">
              <button type="submit" className="px-6 py-2 text-sm font-serif text-white bg-[#2a363b] rounded-md hover:bg-opacity-90 transition">Update Password</button>
            </div>
          </form>
        </div>
      </div>
